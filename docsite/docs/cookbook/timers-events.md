...
Source: [`examples/timers_events_demo.py`](https://github.com/leejianrong/satay-runtime/blob/v0.1.0/examples/timers_events_demo.py)

## Get It And Run It

```bash
pip install 'satay[studio]'
curl -fsSL -O https://raw.githubusercontent.com/leejianrong/satay-runtime/v0.1.0/examples/timers_events_demo.py

...
Source: [`examples/fan_out_recovery_demo.py`](https://github.com/leejianrong/satay-runtime/blob/main/examples/fan_out_recovery_demo.py)

## Get It And Run It

```bash
pip install 'satay[studio] @ git+https://github.com/leejianrong/satay-runtime'
curl -fsSL -O https://raw.githubusercontent.com/leejianrong/satay-runtime/main/examples/fan_out_recovery_demo.py
